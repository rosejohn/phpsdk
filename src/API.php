...
class API {
    public function GetShipment(Form\Shipment\GetShipment $form) {
        $this->validateForm($form);

        $url  = 'https://it.dpdgroup.co.uk/lib/services/shipping/shipment/';
        $json = $this->requestJson($url, $form, 'GET', array('content-type' => 'application/json'));
